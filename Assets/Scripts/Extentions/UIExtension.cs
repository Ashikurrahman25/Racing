...
public static class UIExtension
{
    ...
    public static void DoHorizontalTransition(this GameObject target, float value, Action command, float speed = .4f)
    {
        target.SetActive(true);
    ...
    /// <param name="command"></param>
    /// <param name="speed"></param>
    public static void DoVerticalTransition(this GameObject target, float value, Action command, float speed = .4f)
    {
        target.SetActive(true);
